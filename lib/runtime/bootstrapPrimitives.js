...
import { Storage } from '../primitives/storage.js';
import { NotificationCenter } from '../primitives/notification.js';
 ...
 * @param primitives Primitive facades to bind to configured runtime drivers.
 * @returns {Record<string, string|number|boolean|null>} Configured runtime interface.
 * @example
 * bootstrapPrimitives(ctx, primitives);
 */
